        ...
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start gap-3">
                <span className="text-[#1877F2] font-bold mt-0.5">•</span>
                <span>Generate your Facebook audit report</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#1877F2] font-bold mt-0.5">•</span>
                <span>Deliver your report and account access</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#1877F2] font-bold mt-0.5">•</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-[#1877F2] font-bold mt-0.5">•</span>
                <span>Communicate with you regarding your report</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-start gap-3">
                <span className="text-[#1877F2] font-bold mt-0.5">•</span>
                <span>Improve our marketing and services</span>
              </li>
            </ul>
          </div>
